...
export class MovieService {
  ...
  constructor(private _jsonp: Jsonp) {
    this.apikey = 'xxx';
    console.log('Movie Service is initialized...');
  }
  ...
  getInTheaters() {
    return this._jsonp.get('https:/api.themoviedb.org/3/discover/movie?callback=JSONP_CALLBACK&primary_release_date.gte=2016-12-15&primary_release_date.lte=2017-01-04&api_key=' + this.apikey)
      .map(res => res.json());
  }
